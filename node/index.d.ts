...
declare class Vector2d {
     ...
     */
    static ccw(p1: number[], p2: number[], p3: number[], delta?: number): number;
    /**
    * <p>
    ...
    * defaults to 1e-10.
    */
    static segSegIntersection(ab: number[][], cd: number[][], delta?: number): number[];
    /**
    ...
    * @param l - A line
    */
    static squaredDistanceBetweenPointAndLineSegment(p: number[], l: number[][]): number;
    /**
    ...
    * @param ps
    */
    static translatePs: ICurriedMapFunction2<number[], number[], number[]>;
    /**
    ...
    * @param ps
    */
    static rotatePs: ICurriedMapFunctionSpecial<number, number, number[], number[]>;
    /**
    ...
    **/
    static translateThenRotatePs(v: number[], sinθ: number, cosθ: number, ps: number[][]): number[][];
    /**
    ...
    * @param ps - The input points
    **/
    static rotateThenTranslatePs(sinθ: number, cosθ: number, v: number[], ps: number[][]): number[][];
}
